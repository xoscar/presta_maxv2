...
export default class ClientCard  extends React.Component {
  ...
  showClient(id) {
    ClientActions.getClient(id);
  }

  showModal(id) {
    ClientActions.showLoansModal(id);
  }
      ...
      <div class="col s12 m4">
        <div class="card client">
          ...
          <div class="card-action">
              <Link to={'/clients/' + client.id} class="more green-text darken-2">Más</Link>
              { client.active_loans > 0 ? <a onClick={this.showModal.bind(this, client.id)} class="blue-text darken-2 modal-trigger">Prestamos</a> : ''}
          </div>
        </div>
      </div>
    );
